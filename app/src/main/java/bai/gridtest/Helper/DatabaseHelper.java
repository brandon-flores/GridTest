...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_USER_IMAGE_ID = "user_image_id";
...
//    public void deleteUserVideo(int userid, int categoryid, int videoid){
//        SQLiteDatabase db = this.getWritableDatabase();
//
//        db.delete()
//    }
    ...
    public void addUserVideoNotes(int userid, int videoid, String videoNote){
        ...
        ContentValues values = new ContentValues();
        values.put(COLUMN_ALL_VIDEO_NOTES, videoNote);
    ...
    public void deleteUserCategory(int userid, int categoryid){
        ...
        db.delete(TABLE_USERCATEGORYVIDEO,COLUMN_ALL_USER_ID + " = " + userid
                + COLUMN_ALL_USER_CATEGORY + " = " + categoryid,null);
    }
    ...
    public List<Video> getAllUserVideos(int user_id,int category_id){
        ...
        String query = "SELECT " + COLUMN_VIDEO_ID +"," + COLUMN_VIDEO_NAME + " FROM " + TABLE_VIDEO
                + " INNER JOIN " + TABLE_USERCATEGORYVIDEO
                + " ON " + COLUMN_ALL_USER_ID + " = " + user_id
                + " AND " + COLUMN_ALL_USER_CATEGORY + " = " + category_id
                + " AND " + COLUMN_ALL_USER_VIDEO + " = " + COLUMN_VIDEO_ID;
    ...
    public List<Category> getAllUserCategory(int user_id){
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public void addUser(User user){
        ...
        values.put(COLUMN_USER_IMAGE_ID, user.getImage_id());
    ...
    public User getUser(String username){
        ...
        if(c != null && c.moveToFirst()){
            ...
            user.setImage_id(c.getInt(c.getColumnIndex(COLUMN_USER_IMAGE_ID)));
            c.close();
        }
    ...
    public List<User> getAllUser(){
        ...
        if(c != null && c.moveToFirst()){
            do{
                ...
                user.setUsername(c.getString(c.getColumnIndex(COLUMN_USER_USERNAME)));
                user.setPassword(c.getString(c.getColumnIndex(COLUMN_USER_PASSWORD)));
                user.setImage_id(Integer.parseInt(c.getString(c.getColumnIndex(COLUMN_USER_IMAGE_ID))));
                userList.add(user);
            }while(c.moveToNext());
            c.close();
        }
